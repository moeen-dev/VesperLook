...
<div class="main-content">
    <section class="section">
        ...
        <div class="section-body">
            <h2 class="section-title">All Settings</h2>
                ...
                <div class="col-lg-6">
                    <div class="card card-large-icons">
                        ...
                        <div class="card-body">
                            ...
                            <p>General settings such as, mail, social links, address and so on.</p>
                            <a href="{{ route('admin.setting.general.index') }}" class="card-cta">Update Setting <i
                ...
                <div class="col-lg-6">
                    <div class="card card-large-icons">
                        ...
                        <div class="card-body">
                            ...
                            <a href="{{ route('admin.setting.email.index') }}" class="card-cta">Update Setting <i
                                    class="fas fa-chevron-right"></i></a>
                        </div>
                    </div>
                </div>
