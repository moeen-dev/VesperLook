                    ...
                    <div class="card">
                                ...
                                <table class="table table-striped table-md">
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="{{ route('admin.setting.seo.edit', $seoGeneral->id) }}"
                                                ...
                                                title="Edit this details"><i class="far fa-edit"></i> Edit</a></td>
                                    </tr>
                                    @endforeach
                                    @else
                                    <tr>
                                        <td colspan="6" class="text-center text-danger">
                                            <p>No Data Found!</p>
                                            <a href="{{ route('admin.setting.seo.create') }}" class="btn btn-primary">Create a new
                                                one</a>
                                        </td>
                                    </tr>
                                    @endif
                        ...
                        <div class="card-footer text-right">
                            <nav class="d-inline-block">
                                {{ $seoGenerals->withQueryString()->links('pagination::bootstrap-5') }}
                            </nav>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-12 col-lg-6">
                    <div class="card">
                        ...
                        <div class="card-footer text-right">
                            <nav class="d-inline-block">
                                {{ $seoCollections->withQueryString()->links('pagination::bootstrap-5') }}
                            </nav>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 col-md-12 col-lg-6">
                    <div class="card">
                        ...
                        <div class="card-footer text-right">
                            <nav class="d-inline-block">
                                {{ $seoProducts->withQueryString()->links('pagination::bootstrap-5') }}
                            </nav>
                        </div>
                    </div>
                </div>
