...
<div class="main-content">
    <section class="section">
        ...
        <div class="section-body">
            <h2 class="section-title">Edit your user</h2>
            <p class="section-lead">Edit your User from here</p>
                        ...
                        <div class="card-body">
                            <form action="{{ route('users.update', $user->id) }}" method="POST" class="needs-validation" novalidate="" enctype="multipart/form-data">
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <input type="password" class="form-control" name="password" id="password" autocomplete="new-password" placeholder="Leave blank to keep current password">
