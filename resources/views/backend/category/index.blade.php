                    ...
                    <div class="col-12 col-md-12 col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <a href="{{ route('category.create') }}" class="btn btn-primary"><i class="fa fa-plus"></i>
                                    Add Category</a>
                            </div>
                            <div class="card-body">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="d-flex justify-content-center align-items-center"
                                                            ...
                                                            <a href="{{ route('category.edit', $category->id) }}"
                                                                ...
                                                                title="Edit this category"><i class="far fa-edit"></i>
                                                                Edit</a>
                                                            <form action="{{ route('category.destroy', $category->id) }}"
                                                                method="POST">
                                                                @csrf
                                                                @method('DELETE')
                                                                <button data-toggle="tooltip" title="Delete this category"
