                        ...
                        <div class="card-body">
                            <form action="{{ route('products.store') }}" method="POST" class="needs-validation"
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <label>
                                            <input type="checkbox" name="sizes[]" value="S" {{ in_array('S',
                                                old('sizes', [])) ? 'checked' : '' }}> S
                                        </label>
                                        <label>
                                            <input type="checkbox" name="sizes[]" value="M" {{ in_array('M',
                                                old('sizes', [])) ? 'checked' : '' }}> M
                                        </label>
                                        <label>
                                            <input type="checkbox" name="sizes[]" value="L" {{ in_array('L',
                                                old('sizes', [])) ? 'checked' : '' }}> L
                                        </label>
                                        <label>
                                            <input type="checkbox" name="sizes[]" value="XL" {{ in_array('XL',
                                                old('sizes', [])) ? 'checked' : '' }}> XL
                                        </label>
                                        <label>
                                            <input type="checkbox" name="sizes[]" value="XXL" {{ in_array('XXL',
                                                old('sizes', [])) ? 'checked' : '' }}> XXL
                                        </label>
                                        @if($errors->has('sizes'))
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6 col-md-6 mb-2">
                                                <input type="file" name="image1" id="image1" class="form-image">
                                                @if($errors->has('image1'))
                                                <small style="color: red;">{{ $errors->first('image1')}}</small>
                                                @endif
                                            </div>
                                            <div class="col-sm-6 col-md-6 mb-2">
                                                <input type="file" name="image2" id="image2" class="form-image">
                                            ...
                                            <div class="col-sm-6 col-md-6 mb-2">
                                                <input type="file" name="image3" id="image3" class="form-image">
                                                @if($errors->has('image3'))
                                                <small style="color: red;">{{ $errors->first('image3')}}</small>
                                                @endif
                                            </div>
                                            <div class="col-sm-6 col-md-6 mb-2">
                                                <input type="file" name="image4" id="image4" class="form-image">
                                ...
                                <div class="form-group row mb-4">
                                    <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Is New
                                        Arrival?</label>
                                    <div class="col-sm-12 col-md-7">
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <input type="number" class="form-control" name="quantity"
                                            ...
                                            placeholder="If null or Out of Stock, type 0">
