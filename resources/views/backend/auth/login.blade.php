...
<head>
    ...
    <!-- CSS Libraries -->
    <link rel="stylesheet" href="{{ asset('assets/backend/assets/modules/bootstrap-social/bootstrap-social.css') }}">
...
<body>
                ...
                <div class="row">
                    <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
                        <div class="login-brand">
                            <img src="{{ url('assets/backend/assets/img/vesper_look.jpg') }}" alt="logo" width="100" class="shadow-light rounded-circle">
                        </div>
                        ...
                        <div class="simple-footer">
                            Copyright &copy; VesperLook 2024
                        </div>
                    </div>
                </div>
            </div>
    ...
    <!-- General JS Scripts -->
    <script src="{{ asset('assets/backend/assets/modules/jquery.min.js') }}">
    </script>
