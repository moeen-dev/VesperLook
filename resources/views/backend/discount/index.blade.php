                    ...
                    <div class="col-12 col-md-12 col-lg-12">
                        <div class="card">
                            <div class="card-header d-flex justify-content-between">
                                <a href="{{ route('coupon.create') }}" class="btn btn-primary"><i class="fa fa-plus"></i>
                                    Add Coupon</a>
                            </div>
                            <div class="card-body">
                                                ...
                                                @foreach ($discounts as $discount)
                                                    <tr>
                                                        ...
                                                        <td class="d-flex justify-content-center align-items-center"
                                                            style="gap: 10px;">
                                                            <form action="{{ route('coupon.destroy', $discount->id) }}"
                                                                method="POST">
                                                                @csrf
                                                                @method('DELETE')
                                                                <button data-toggle="tooltip" title="Delete this Coupon"
