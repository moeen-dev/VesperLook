                    ...
                    <form action="{{ route('user.register.submit') }}" method="POST">
                        ...
                        <div class="row">
                            <div class="col-xl-12">
                                ...
                                @enderror
                                <input type="text" placeholder="Your Name*" name="name" id="name" required autocomplete="off" value="{{ old('name') }}">
                            </div>
                            <div class="col-xl-12">
                                @error('email')
                                <div class="alert alert-danger mt-2 mb-0 py-1 px-2" role="alert">
                                ...
                                @enderror
                                <input type="email" placeholder="Eamil*" name="email" id="email" required autocomplete="off" value="{{ old('email') }}">
                            </div>
                            <div class="col-xl-12">
                            ...
                            <div class="col-xl-12">
                                <input type="text" placeholder="Shipping Address*" name="shipping_address" id="shipping_address" required autocomplete="off" value="{{ old('shipping_address') }}">
                            </div>
                            <div class="col-xl-12">
                                <input type="text" placeholder="Billing Address*" name="billing_address" id="billing_address" required autocomplete="off" value="{{ old('billing_address') }}">
                            </div>
                            <div class="col-xl-12">
