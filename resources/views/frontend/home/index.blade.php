...
>>>>>>> e778175ecbf6f1038b79103e7e8baf910dc3689d
            </div>
        </section>
                                        ...
                                        <div class="sin-product style-two">
                                            ...
                                            <div class="mid-wrapper">
                                                <h5 class="pro-title"><a
                                                        href="{{ route('shop.details', ['categorySlug' => $product->subCategory->category->slug, 'subcategorySlug' => $product->subCategory->slug, 'productSlug' => $product->slug]) }}">{{ $product->title }}</a>
                                                </h5>
                                    ...
                                    <div class="grid-item three col-12 col-md-6  col-lg-4 col-xl-3">
                                        <div class="sin-product style-two">
                                            ...
                                            <div>
                                                ...
                                                <span
                                                    class="new-tag">{{ $daysAgo >= 1 ? $daysAgo . ' days ago' : 'Now' }}</span>
                                            </div>
                                            <div class="mid-wrapper">
                                                <h5 class="pro-title"><a
                                                        href="{{ route('shop.details', ['categorySlug' => $product->subCategory->category->slug, 'subcategorySlug' => $product->subCategory->slug, 'productSlug' => $product->slug]) }}">{{ $product->title }}</a>
